...
@section('content')
<div class="mb-4">
    <h2 class="font-bold text-xl">Detail Retur Pembelian #{{ $retur->id_retur_pembelian }}</h2>
</div>
...
<div class="bg-white p-6 rounded shadow mb-4">
    <div class="grid grid-cols-2 gap-4 mb-4">
        <div>
            ...
            <p class="font-bold">{{ $retur->distributor->nama_distributor }}</p>
        </div>
        <div>
        ...
        <div>
            <p class="text-gray-600">Gudang Asal:</p>
            <p class="font-bold">{{ $retur->gudang->nama_gudang ?? '-' }}</p>
        </div>
        <div>
    ...
    <div class="mt-4">
        <a href="{{ route('owner.retur-pembelian.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300">Kembali</a>
    </div>
</div>
@endsection
