...
@section('title', 'Edit Pendapatan Pasif')
@section('content')
<div class="flex justify-between items-center mb-3">
    <h2 class="font-bold text-lg border-b-2 border-gray-500 pr-4"><i class="fa fa-edit"></i> EDIT PENDAPATAN PASIF</h2>
...
<div class="bg-white border border-gray-400 p-4">
    <form action="{{ route("owner.pendapatan_pasif.update", $pendapatan_pasif->id_pendapatan_pasif)') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex gap-2 mt-4">
            <button type="submit" class="bg-blue-700 text-white border border-blue-900 px-4 py-2 text-xs hover:bg-blue-600"><i class="fa fa-save"></i> UPDATE PENDAPATAN PASIF</button>
