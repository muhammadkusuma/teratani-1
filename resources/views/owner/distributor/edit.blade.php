...
@section('content')
    <div class="max-w-3xl">
        ...
        <div class="flex justify-between items-center mb-4">
            <h2 class="font-bold text-lg border-b-2 border-gray-500 pr-4">EDIT DATA DISTRIBUTOR</h2>
            <a href="{{ route('owner.distributor.index') }}" class="text-blue-700 underline text-xs hover:text-blue-500">&laquo;
                Kembali</a>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="nama_kontak"
                        value="{{ old('nama_kontak', $distributor->nama_kontak) }}"
                        class="w-full border border-gray-400 p-1 text-sm focus:outline-none focus:border-blue-600">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="alamat" rows="3"
                        class="w-full border border-gray-400 p-1 text-sm focus:outline-none focus:border-blue-600">{{ old('alamat', $distributor->alamat) }}</textarea>
                </div>
