...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
    <h2 class="font-bold text-xl border-b-4 border-blue-600 pb-1 pr-6 uppercase tracking-tight">
        <i class="fa fa-user-plus text-blue-700"></i> Tambah Karyawan
    </h2>
    ...
    <form action="{{ route('owner.karyawan.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="id_toko" required class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm bg-gray-50">
                    ...
                    <option value="{{ $store->id_toko }}" {{ old('id_toko') == $store->id_toko ? 'selected' : '' }}>{{ $store->nama_toko }}</option>
                    @endforeach
                </select>
            </div>
            <div>
                ...
                <input type="text" name="kode_karyawan" value="{{ old('kode_karyawan', $kodeKaryawan) }}" required class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner font-mono focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div>
                ...
                <input type="text" name="nik" value="{{ old('nik') }}" class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
            <div class="md:col-span-2">
                <label class="block font-black mb-2 text-[10px] text-gray-500 uppercase tracking-wider">
                    Nama Lengkap <span class="text-red-600">*</span>
                </label>
                <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap') }}" required class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            <div>
                ...
                <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir') }}" class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
            <div>
                <label class="block font-black mb-2 text-[10px] text-gray-500 uppercase tracking-wider">Tanggal Lahir</label>
                <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
            <div>
                <label class="block font-black mb-2 text-[10px] text-gray-500 uppercase tracking-wider">
        ...
        <div class="mt-4">
            ...
            <textarea name="alamat" rows="2" class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">{{ old('alamat') }}</textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
                ...
                <input type="text" name="no_hp" value="{{ old('no_hp') }}" required class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
            <div>
                <label class="block font-black mb-2 text-[10px] text-gray-500 uppercase tracking-wider">Email</label>
                <input type="email" name="email" value="{{ old('email') }}" class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            ...
            <div>
                ...
                <input type="date" name="tanggal_masuk" value="{{ old('tanggal_masuk') }}" required class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
            <div>
                <label class="block font-black mb-2 text-[10px] text-gray-500 uppercase tracking-wider">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
                ...
                <input type="number" name="gaji_pokok" value="{{ old('gaji_pokok', 0) }}" min="0" step="1000" class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">
            </div>
            <div>
        ...
        <div class="mt-4">
            ...
            <textarea name="keterangan" rows="2" class="w-full border border-gray-300 p-2.5 md:p-1.5 text-xs shadow-inner focus:border-blue-500 focus:ring-1 focus:ring-blue-200 outline-none transition-all rounded-sm">{{ old('keterangan') }}</textarea>
        </div>
