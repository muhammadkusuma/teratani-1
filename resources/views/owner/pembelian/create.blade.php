...
@section('content')
    <div class="flex flex-col h-[calc(100vh-80px)] w-full" x-data="invoiceHandler()">
        ...
        {{-- ================================================================= --}}
        {{-- BAGIAN INI YANG HILANG SEBELUMNYA (ALERT SUCCESS / ERROR) --}}
        {{-- ================================================================= --}}
        ...
        @if ($errors->any())
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-2 rounded relative mb-2 text-sm"
                role="alert">
            ...
            return {
                ...
                validateForm() {
                    ...
                    if (this.statusBayar !== 'Lunas') {
                        let tglTempo = document.querySelector('input[name="tgl_jatuh_tempo"]').value;
                        if (!tglTempo) {
                            alert("Mohon isi Tanggal Jatuh Tempo untuk transaksi Hutang/Sebagian.");
                            return false;
                        }
                    }
                    return true;
