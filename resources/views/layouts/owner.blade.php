        ...
        <div class="flex flex-wrap items-center">
            ...
            @if (session('toko_active_id'))
                ...
                <a href="{{ route('owner.pelanggan.index') }}"
                    class="px-4 py-2 hover:bg-orange-500 border-r border-blue-700 flex items-center gap-1 transition-colors {{ request()->routeIs('owner.pelanggan.*') ? 'bg-orange-600 font-bold' : '' }}">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
